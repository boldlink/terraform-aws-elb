...
| <a name="input_load_balancer_policies"></a> [load\_balancer\_policies](#input\_load\_balancer\_policies) | Load balancer policy resource block for single or multiple resources | `any` | n/a | yes |
